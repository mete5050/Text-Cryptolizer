...
while (say < 10000):#10000 yerine daha büyük bir sayı girebilirsiniz fakat bu sefer bilgisayarınız zorlanabillir
    harfler=['e','Ö','k','Y','f','g','C','h','V','a','T','D','b','X','ö','F','ç','i','j','l','m','O','n','c','d','o','Ç','p','r','s','t','y','z','x','u','ü','v','K','w','L',':',',','`','@','.','-','=','J','Ü','(','P',')','R','[','U',']','İ','&','W','%','Ş','+','$','I','S','#','A','Q','^','Z','!','>','_','B','é','\ ','£','1','G','2','9','/','*','0','N','7','6','8','H','4','ı','5','M','E','3','']#,''
